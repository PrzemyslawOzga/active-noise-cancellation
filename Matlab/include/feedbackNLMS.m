...
function results = feedbackNLMS(signal, pzFilter, bufferSize, testCaseName, testMode)
    ...
    for ids = bufferSize:signalLength
        ...
        nlmsOutput = nlmsOutput + tempAdaptationStep(ids) * identErrorBuffer * identError(ids);
    end
